    ...
    if (self._flag_5 == False):
      ...
      if (self._flag_2 == False):
        ...
        for selected_marine in selected_marines:
          ...
          #print("selected_marine: " + str(selected_marine))
          #print("")
        #print("")
        ...
        if ( (selected_marines_x_mean > roache_x_mean) & (selected_marines_y_mean > roache_y_mean) ):
          ...
          x_point = selected_marines_x_mean
          y_point = selected_marines_y_mean
      ...
      if (self._flag_4 == False):
        ...
        if ( (selected_marines_x_mean > roache_x_mean) & (selected_marines_y_mean > roache_y_mean) ):
          ...
          x_point = roache_x_mean
          y_point = roache_y_mean
