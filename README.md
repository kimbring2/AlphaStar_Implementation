...
# Notice
Current, I am migrating from [old code style](https://github.com/pythonlessons/Reinforcement_Learning/blob/master/LunarLander-v2_PPO/LunarLander-v2_PPO.py) of Tensorflow to [new code style](https://www.tensorflow.org/tutorials/reinforcement_learning/actor_critic]) because of memory leak issue during training. It seems like it is only problem of PySC2 when using it with Tensorflow 2 version. Other environment suah as LunarLander-v2 of OpenAI Gym has not same problem.
